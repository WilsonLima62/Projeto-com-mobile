...
import '../styles/pages/createPontosHistoricos.css';
...
export default function CreatePontosHistoricos(){
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    return(
        ...
        <main>
          <form onSubmit={handleSubmit} className="create-pontoHistorico-form">
            <fieldset>
              <legend>Dados</legend>
             ...
             return (
              ...
              <div className="input-block">
                ...
                <textarea id="name" maxLength={800} 
                 value={about} 
            ...
            <fieldset>
              ...
              <div className="input-block">
                <label htmlFor="open_on_weekends">Precisa agendamento</label>
